...
namespace vendor\kouosl\servis\models;

use Yii;
use vendor\kouosl\servis\models\Servis;
use vendor\kouosl\servis\models\ServisSearch;
...
class ServisController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            return $this->redirect(['view', 'id' => $model->servis_id]);
        }
